    ...
    <div className="flex flex-col min-h-screen bg-[#0A0A0A] text-white overflow-x-hidden">
      ...
      <section className="border-b border-[#1E1E1E] px-4 sm:px-6 py-16 sm:py-24 relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0"
          style={{ background: "radial-gradient(ellipse at 30% 50%, rgba(255,45,120,0.05) 0%, transparent 60%)" }} />
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <AnimateIn delay={0}>
              <TiltCard className="relative overflow-hidden rounded-2xl border border-[#2A2A2A] bg-[#141414] p-6 sm:p-7 h-full card-hover">
                <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#FF2D78]/10 to-transparent" />
                <div className="relative">
                  <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-[#1E1E1E]">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><circle cx="7" cy="11" r="5" stroke="#FF2D78" strokeWidth="1.5"/><circle cx="15" cy="11" r="5" stroke="#FF2D78" strokeWidth="1.5" opacity="0.6"/></svg>
                  </div>
                  <h3 className="mb-1 text-base sm:text-lg font-semibold text-white" style={{ fontFamily: "var(--font-dm-sans)" }}>Compatibility Score</h3>
                  <p className="text-xs font-medium mb-2" style={{ color: "#FF2D78" }}>Not just the same artist. The same feeling.</p>
            ...
            <AnimateIn delay={80}>
              <TiltCard className="relative overflow-hidden rounded-2xl border border-[#2A2A2A] bg-[#141414] p-6 sm:p-7 h-full card-hover">
                <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#A855F7]/8 to-transparent" />
                <div className="relative">
                  <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-[#1E1E1E]">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><rect x="2" y="6" width="18" height="13" rx="2" stroke="#A855F7" strokeWidth="1.5"/><path d="M7 6V4a2 2 0 0 1 4 0v2" stroke="#A855F7" strokeWidth="1.5" strokeLinecap="round"/></svg>
                  </div>
                  <h3 className="mb-1 text-base sm:text-lg font-semibold text-white" style={{ fontFamily: "var(--font-dm-sans)" }}>Music Museum</h3>
                  <p className="text-xs font-medium mb-2" style={{ color: "#A855F7" }}>Your taste. Your history. Your identity.</p>
            ...
            <AnimateIn delay={320} className="sm:col-span-2 lg:col-span-1">
              <TiltCard className="relative overflow-hidden rounded-2xl border border-[#2A2A2A] bg-[#141414] p-6 sm:p-7 h-full card-hover">
                ...
                <div className="relative">
                  <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-[#1E1E1E]">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"><circle cx="9" cy="8" r="3.5" fill="#FF2D78"/><circle cx="15" cy="8" r="3.5" fill="#FF2D78" opacity="0.6"/><path d="M2 20c0-3.31 3.13-6 7-6s7 2.69 7 6" stroke="#FF2D78" strokeWidth="1.5" strokeLinecap="round"/><path d="M17 14c2.21 0 4 1.79 4 4" stroke="#FF2D78" strokeWidth="1.5" strokeLinecap="round" opacity="0.6"/></svg>
                  </div>
                  <h3 className="mb-1 text-base sm:text-lg font-semibold text-white" style={{ fontFamily: "var(--font-dm-sans)" }}>Mutual Connect</h3>
                  <p className="text-xs font-medium mb-2" style={{ color: "#FF2D78" }}>Every conversation starts with real interest.</p>
